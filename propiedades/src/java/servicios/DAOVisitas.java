...
/**
 * Jersey REST client generated for REST resource:VisitasFacadeREST
 * [servicios.visitas]<br>
 * USAGE:
 * <pre>
 *        DAOVisitas client = new DAOVisitas();
...
public class DAOVisitas {
    ...
    public DAOVisitas() {
        ...
        webTarget = client.target(BASE_URI).path("servicios.visitas");
    }
