...
/**
 * Jersey REST client generated for REST resource:DireccionesFacadeREST
 * [servicios.direcciones]<br>
 * USAGE:
 * <pre>
 *        DAODirecciones client = new DAODirecciones();
...
public class DAODirecciones {
    ...
    public DAODirecciones() {
        ...
        webTarget = client.target(BASE_URI).path("servicios.direcciones");
    }
