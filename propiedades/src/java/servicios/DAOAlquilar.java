...
/**
 * Jersey REST client generated for REST resource:AlquilarFacadeREST
 * [servicios.alquilar]<br>
 * USAGE:
 * <pre>
 *        DAOAlquilar client = new DAOAlquilar();
...
public class DAOAlquilar {
    ...
    public DAOAlquilar() {
        ...
        webTarget = client.target(BASE_URI).path("servicios.alquilar");
    }
