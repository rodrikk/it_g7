...
/**
 * Jersey REST client generated for REST resource:SegurosFacadeREST
 * [servicios.seguros]<br>
 * USAGE:
 * <pre>
 *        DAOSeguros client = new DAOSeguros();
...
public class DAOSeguros {
    ...
    public DAOSeguros() {
        ...
        webTarget = client.target(BASE_URI).path("servicios.seguros");
    }
