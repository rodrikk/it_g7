...
/**
 * Jersey REST client generated for REST resource:ValoracionesFacadeREST
 * [servicios.valoraciones]<br>
 * USAGE:
 * <pre>
 *        DAOValoraciones client = new DAOValoraciones();
...
public class DAOValoraciones {
    ...
    public DAOValoraciones() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("servicios.valoraciones");
    }
