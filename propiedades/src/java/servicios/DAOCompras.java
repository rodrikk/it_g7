...
/**
 * Jersey REST client generated for REST resource:ComprasFacadeREST
 * [servicios.compras]<br>
 * USAGE:
 * <pre>
 *        DAOCompras client = new DAOCompras();
...
public class DAOCompras {
    ...
    public DAOCompras() {
        ...
        webTarget = client.target(BASE_URI).path("servicios.compras");
    }
