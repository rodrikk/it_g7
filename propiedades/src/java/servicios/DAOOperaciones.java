...
/**
 * Jersey REST client generated for REST resource:OperacionesFacadeREST
 * [servicios.operaciones]<br>
 * USAGE:
 * <pre>
 *        DAOOperaciones client = new DAOOperaciones();
...
public class DAOOperaciones {
    ...
    public DAOOperaciones() {
        ...
        webTarget = client.target(BASE_URI).path("servicios.operaciones");
    }
