...
/**
 * Jersey REST client generated for REST resource:FavoritosFacadeREST
 * [servicios.favoritos]<br>
 * USAGE:
 * <pre>
 *        DAOFavoritos client = new DAOFavoritos();
...
public class DAOFavoritos {
    ...
    public DAOFavoritos() {
        ...
        webTarget = client.target(BASE_URI).path("servicios.favoritos");
    }
