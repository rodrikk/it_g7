...
/**
 * Jersey REST client generated for REST resource:AlquileresFacadeREST
 * [servicios.alquileres]<br>
 * USAGE:
 * <pre>
 *        DAOAlquileres client = new DAOAlquileres();
...
public class DAOAlquileres {
    ...
    public DAOAlquileres() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("servicios.alquileres");
    }
