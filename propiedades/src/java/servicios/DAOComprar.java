...
/**
 * Jersey REST client generated for REST resource:ComprarFacadeREST
 * [servicios.comprar]<br>
 * USAGE:
 * <pre>
 *        DAOComprar client = new DAOComprar();
...
public class DAOComprar {
    ...
    public DAOComprar() {
        ...
        webTarget = client.target(BASE_URI).path("servicios.comprar");
    }
