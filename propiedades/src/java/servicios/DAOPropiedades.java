...
/**
 * Jersey REST client generated for REST resource:PropiedadesFacadeREST
 * [servicios.propiedades]<br>
 * USAGE:
 * <pre>
 *        DAOPropiedades client = new DAOPropiedades();
...
public class DAOPropiedades {
    ...
    public DAOPropiedades() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("servicios.propiedades");
    }
