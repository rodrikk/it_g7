    ...
    <body>
        ...
        <div class="container mt-4">
            ...
            <s:if test="%{#session.idUsuario}">
                <div>
                    <s:form id="buscarPropiedades" name="buscarPropiedades" action="buscarPropiedades" method="POST">
                        <div class="input-group mb-3">
                            <s:textfield id="ciudad" name="ciudad"  placeholder="Buscar por ciudad"/>
                            <s:submit name="boton" value="Buscar" cssClass="btn btn-primary btn-sm"></s:submit>
                            </div>
                        </div>
                </s:form>
            </div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <s:iterator value="valoracionesTotales" var="valoracionTotal">
                        <tr>
                            <td><img src="<s:property value="#valoracionTotal.idPropiedad.foto"></s:property>"/></td>
